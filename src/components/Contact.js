...
const Contact = () => {
  ...
  const isFormValid = () => {
    // 檢查是否所有必填欄位都有值且沒有錯誤
    const hasAllFields = formData.name.trim() && formData.email.trim() && formData.message.trim();
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <a href="mailto:peggy.yen1999@gmail.com" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="https://github.com/chung-coder" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                  ...
                  <a href="https://linkedin.com/in/tingchen-yen/" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
